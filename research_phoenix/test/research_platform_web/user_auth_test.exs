defmodule ResearchPlatformWeb.UserAuthTest do
  use ResearchPlatformWeb.ConnCase, async: true

  alias ResearchPlatform.Accounts
  alias ResearchPlatform.Accounts.Scope
  alias ResearchPlatformWeb.UserAuth

  import ResearchPlatform.AccountsFixtures

  @remember_me_cookie "_research_platform_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ResearchPlatformWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
